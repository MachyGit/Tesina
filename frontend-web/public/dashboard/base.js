...
// Backend: por defecto, mismo host desde el que se abrió la página (puerto 5000).
// Así funciona igual en localhost y accediendo desde otra PC de la red.
if (!window.BACKEND_URL) {
  window.BACKEND_URL = `${window.location.protocol}//${window.location.hostname}:5000`;
}
